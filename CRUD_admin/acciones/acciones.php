...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['avatar'])) {
        ...
        if (move_uploaded_file($archivoTemporal, $rutaDestino)) {
            ...
            $sql = "INSERT INTO $usuarios (curp, numero_empleado, nombre, primer_ap, segundo_ap, cargo, avatar) 
            VALUES ('$curp', '$numero_empleado', '$nombre', '$primer_apellido', '$segundo_apellido', '$cargo', '$nombreArchivo')";
...
{
    $sql = "SELECT * FROM usuarios ORDER BY curp ASC";
