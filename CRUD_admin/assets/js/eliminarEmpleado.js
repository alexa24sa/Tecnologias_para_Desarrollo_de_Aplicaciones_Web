 ...
 */
async function eliminarEmpleado(curp, avatarEmpleado) {
  try {
    ...
    document
      ...
      .addEventListener("click", async function () {
        ...
        var curp = this.getAttribute("data-id");
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            document.querySelector(`#empleado_${curp}`).remove();
            ...
            alert(`Error al eliminar el empleado con ID ${curp}`);
          }
        } catch (error) {
          console.error(error);
